          ...
          <div className='flex justify-between w-full'>
            <div className='flex flex-col gap-y-1 px-8 w-full xl:py-0 lg:py-32 md:py-40 sm:py-48 min-[425px]:py-56 py-60'>
              <h1 className={`${pageLoad ? 'animate-fadeIn' : 'opacity-0'} text-white font-bold sm:text-6xl text-4xl font-kanit`}>
                Hey, I&apos;m
                <span className={`duration-1000 ${titleColor}`}> Ozin</span>
                <span className='text-gray-400 sm:text-base text-sm sm:pl-1 pl-0 italic sm:inline flex'> aka Ozzers</span>
              </h1>
              <p className={`${descLoad ? 'animate-fade-in-left' : 'opacity-0'} text-white font-semibold sm:text-2xl text-xl font-kanit`}>
                I&apos;m a 15 year old full-stack developer from London.
              </p>
              <ul className='flex flex-row flex-wrap w-fit gap-2'>
                <Socialicon
                  href='https://youtube.com/@zehnyman'
                ...
                />
                <Socialicon
                  href='https://instagram.com/ottoread'
                ...
                />
                <Socialicon
                  href='https://namemc.com/profile/Ozin'
            ...
            <img draggable={false} className={`relative rounded-full lg:w-72 w-0 border-2 border-blue-700 h-fit xl:-translate-y-14 lg:translate-y-6 mr-8 -translate-y-0 lg:scale-100 scale-0 ${imageLoad ? 'animate-fadeIn' : 'opacity-0'}`} alt="image" src='https://media.discordapp.net/attachments/803973344340475946/1115239220135596102/D04BCC47-1014-4FCD-8BA1-C573BCD26168.jpg?width=679&height=905' />
          </div>
        </section>
              ...
              <p ref={ref} className={`text-white text-md font-kanit`}>
                {inView && (
                  <Typewriter
                    options={{
                      delay: 30,
                      strings: ["My name is Ozin, I'm 15 years old and I currently live in London. I have been interested in web development since 13 years old but never really attempted to make anything until I was 14 almost 15 years old. I am still at school and currently studying computer science to better my skills."],
                      loop: false,
                      autoStart: true,
